...
[![React DevTools em um site com a versão de produção do React](https://pt-br.reactjs.org/static/d0f767f80866431ccdec18f200ca58f1/0a47e/devtools-prod.png)](https://pt-br.reactjs.org/static/d0f767f80866431ccdec18f200ca58f1/0a47e/devtools-prod.png)

Se você visitar um site com React em modo de desenvolvimento, o ícone terá um fundo vermelho:

[![React DevTools em um site com a versão de desenvolvimento do React](https://pt-br.reactjs.org/static/e434ce2f7e64f63e597edf03f4465694/0a47e/devtools-dev.png)](https://pt-br.reactjs.org/static/e434ce2f7e64f63e597edf03f4465694/0a47e/devtools-dev.png)
...
> **Observação:**
>
> Se você está usando Create React App, por favor siga [as instruções acima](https://pt-br.reactjs.org/docs/optimizing-performance.html#create-react-app).
...
Uma visão geral do Profiler pode ser encontrada nesse artigo [“Introducing the React Profiler”](https://pt-br.reactjs.org/blog/2018/09/10/introducing-the-react-profiler.html). Um vídeo com o passo a passo do profiler também está [disponível no YouTube](https://www.youtube.com/watch?v=nySib7ipZdk).
...
> Observação
>
> Uma analise de uma build de produção do `react-dom` está disponível como `react-dom/profiling`. Leia mais sobre como usar esse pacote no [fb.me/react-profiling](https://fb.me/react-profiling)

> Observação
>
> Antes do React 17, usamos o padrão [User Timing API](https://developer.mozilla.org/en-US/docs/Web/API/User_Timing_API) para criar o perfil de componentes com a guia de desempenho do chrome. Para um passo a passo mais detalhado, confira [este artigo de Ben Schwarz](https://calibreapp.com/blog/react-performance-profiling-optimization).
...
Na maioria dos casos, ao invés de escrever `shouldComponentUpdate()` na mão, você pode herdar do [`React.PureComponent`](https://pt-br.reactjs.org/docs/react-api.html#reactpurecomponent). Ele equivale a implementação do `shouldComponentUpdate()` com uma comparação rasa entre as anteriores e novas propriedades e estados
...
[![should component update](https://pt-br.reactjs.org/static/5ee1bdf4779af06072a17b7a0654f6db/cd039/should-component-update.png)](https://pt-br.reactjs.org/static/5ee1bdf4779af06072a17b7a0654f6db/cd039/should-component-update.png)
